---
title: "How I deploy Laravel apps in Docker with just two commands"
layout: post
...
category: blog
author: jdsantos
description: Get your app up and running on Docker (or Podman) with just two commands
---

Hi there! It's Jorge. It's been a while since my last post, and this one might sound the same as [one that you might have read around here](https://jdsantos.github.io/my-ready-to-use-all-in-one-recipe-for-laravel-10-deployment-in-docker). But come along and I promise you that you never again will have to build docker images from scratch to your [Laravel](https://laravel.com) projects!
