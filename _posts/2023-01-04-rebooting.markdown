...
I commanded the computer to do something and *it did*. At that time, that was somewhat of a form of power or weird magic.
So, as the initial excitement with Bomberman wore off, I started to gaze at ZX Spectrum itself: a lot of keys, of which I only used a few. If only those that I knew started a game, what could the others do? Curiosity sent me off to explore the hidden gems of the ZX, but with little or no help, not much to tell here besides my typing skills; I loved to type in full pages of books onto the text editor. It seemed to me like a cool job for someone to have.
